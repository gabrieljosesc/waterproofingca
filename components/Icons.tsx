...
export function DropIcon({ size = 26 }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 2.7 6.6 9.4a7 7 0 1 0 10.8 0L12 2.7z" />
    </svg>
  );
}

export function ShieldDropIcon({ size = 26 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M12 8.2 9.9 11a2.6 2.6 0 1 0 4.2 0L12 8.2z" />
    </svg>
  );
}

export function AlertIcon({ size = 26 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PumpIcon({ size = 26 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CrackIcon({ size = 26 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M13 3l-2 5 3 3-3 4 2 6" />
    </svg>
  );
}

export function DrainIcon({ size = 26 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M3 6c2 0 2 2 4 2s2-2 4-2 2 2 4 2 2-2 4-2" />
...
export function ClipboardIcon({ size = 26 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DollarIcon({ size = 26 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
